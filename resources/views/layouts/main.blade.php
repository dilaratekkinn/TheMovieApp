...
<nav class="border-b border-gray-800">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
        ...
        <div class="flex flex-dol md:flex-row items-center">
            <livewire:search-dropdown>

                <div class="md:ml-3 mt-4 md:mt-0">
                    <a href="">
                        <img
                            src="https://e7.pngegg.com/pngimages/699/116/png-clipart-catwoman-batman-superman-superhero-dc-vs-marvel-dancing-party-comics-mammal-thumbnail.png"
